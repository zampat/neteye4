...
function get-SQLXECURSORSScript
{
    ...
    ADD EVENT sqlserver.cursor_execute(
        ACTION(sqlserver.client_hostname,sqlserver.context_info,sqlserver.query_hash,sqlserver.query_plan_hash,sqlserver.server_instance_name,sqlserver.session_id)),
