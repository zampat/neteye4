...
PERFDATA="ok_services=$NUM_OF_OK;$MIN_OK_WARN;$MIN_OK_CRIT critical_incidents=$NUM_OF_CRITICAL_INCIDENT;$MAX_INCIDENT_WARN;$MAX_INCIDENT_CRIT critical_acknowledged=$NUM_OF_CRITICAL_ACK;; critical_downtime=$NUM_OF_CRITICAL_DOWNTIME;;"
