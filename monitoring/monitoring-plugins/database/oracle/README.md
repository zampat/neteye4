...
- Install [neteye monitoring template library](../../../../doc/030_neteye_template_library.md) and make use of service tempalte "generic_oracle_health" 
- Install pre-requisites for running the plugin:
